...
namespace AutoAukcionas.Controllers
{
    ...
    public class CarController : ControllerBase
    {
        ...
        public async Task<ActionResult<CarDto>> Create(int CountryId, [FromBody]CarPostDto dto)
        {
        ...
        {
            if (string.IsNullOrEmpty(model.CarImage))
            {
                return null;
            }

            var imageData = Convert.FromBase64String(model.CarImage);
